...
export class CreatePresetDialogComponent extends DialogContentBaseComponent<CreatePresetDialogPayload>
  implements OnInit {

  errors: FieldError[] = [];

  constructor(private requestTemplatePresetService: RequestTemplatePresetService) {
    super();
  }
  ...
  @ShowLoader()
  protected async onFormSubmit(payload: CreateRequestTemplatePreset): Promise<void> {
    this.errors = [];
